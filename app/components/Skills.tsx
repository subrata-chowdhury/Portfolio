    ...
    <section className="screen-container">
      <div className="heading" id="skills">
        ...
        <div className="btn-container">
          <FilterButton
            onClickHandler={() => setShowOnlyTopSkills((val) => !val)}
            active={showOnlyTopSkills}
          />
          <SortButton
            onClickHandler={() => {
      ...
      <SkillsContainer
        ...
        showOnlyTopSkills={showOnlyTopSkills}
      />
    </section>
  );
}
        ...
        title={
          lvl && (
            <div className="skill-details">
              <Image
                src={`/icons/star${lvl === 1 || lvl === 2 || lvl === 3 ? "-fill" : ""}.svg`}
                width={15}
                height={15}
                alt="star-icon"
              />
              <Image
                src={`/icons/star${lvl === 2 || lvl === 3 ? "-fill" : ""}.svg`}
                width={15}
                height={15}
                alt="star-icon"
              />
              <Image
                src={`/icons/star${lvl === 3 ? "-fill" : ""}.svg`}
                width={15}
                height={15}
                alt="star-icon"
              />
  ...
  return (
    <Model onClose={onClose}>
      <div className="skill-details-container">
        ...
        <ProjectsContainer
          projectData={projectsData.filter((project) => {
            return (
